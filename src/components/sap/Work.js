...
const Work = () => (
  <section className="container mb-5 pb-5" id="work">
    ...
    <div className="work-description mb-4 pt-5 pb-1">
      <div className="row">
        <h3 className="col-sm text-center">Process Oriented Design</h3>
      </div>
      <div className="row">
        <p className="col-sm text-center">
          Throughout my projects, I focus on applying the design thinking
          process throughout and utilizing UX tools and deliverables as needed
          for a final user-oriented design
        </p>
      </div>
    </div>
    ...
    <div className="work-description mb-4 pt-5 pb-1 pr-1 pl-1">
      ...
      <div className="row">
        <p className="col-sm text-center">
          I design responsive experiences that span devices and meet modern
          business users where they are
        </p>
      </div>
    </div>
