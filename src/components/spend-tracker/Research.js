  ...
  <Section shade={1} title="Research">
    <SubSection title="Market Research">
      <p>
        ...
        metrics, like Cost per Action (CPA) and Return on Advertising Spend
        (ROAS), that are tied to internal company goals to gauge success when
        managing their budgets and spend. From a{' '}
        <a
    ...
    <SubSection title="User Research">
      ...
      <p>
        ...
        our persona the marketing manager Amy who captured the scenario, goals,
        and tasks of our interview participants.
      </p>
      ...
      <p>
        ...
        our interview participants so we could begin to define the core
        experience.{' '}
      </p>
      <Image
