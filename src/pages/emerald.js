...
const Emerald = () => (
  <Fragment>
    ...
    <Overview
      brief="For this hackathon project, the city of Seattle is looking for a product that will help to solve a local civic problem."
      client="City of Seattle"
      tools="Pen & Paper, Whiteboard, Sketch, Keynote"
      deliverables="Working Prototype, Presentation"
      team="2 engineers, 2 designers"
      impact="During this hackathon client project, I was the lead on information architecture, interaction design and visual design. I led the business analysis research in terms of heuristic analysis of the current product, comparative analysis, and feature comparison in the market. I led the initial sketches, led a design studio, developed the current and future state sitemaps, user flows, low and high fidelity prototypes. I also designed the Emerald Seattle branding for the project."
